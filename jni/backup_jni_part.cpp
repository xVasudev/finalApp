...
extern "C" {
JNIEXPORT void JNICALL Java_com_tesseract_studio3d_Animation_MainActivity_getThreshold(JNIEnv* env, jobject, jlong addrBgr, jlong addrDisp, jlong addrBackground,jlong addrForeground,jlong finalImage, jint ji1, jint ji2,jint currentMode);
...
JNIEXPORT void JNICALL Java_com_tesseract_studio3d_Animation_MainActivity_getThreshold(JNIEnv* env, jobject, jlong addrBgr, jlong addrDisp, jlong finalImage,jlong addrBackground,jlong addrForeground, jint ji1, jint ji2,jint currentMode)
{
	Mat& img = *(Mat*)addrBgr;
    ...
    imwrite("/mnt/sdcard/SimpleImageCapture/img_fg.png", foreground);
    imwrite("/mnt/sdcard/SimpleImageCapture/img_bg.png", background);
    ...
    env->SetFloatArrayRegion(contourPoints, 0, 2*tLen, cPoints);
    jsize arraylen=env->GetArrayLength( contourPoints);
    sprintf(str, "%d", arraylen);


    string filename = "/mnt/sdcard/Stereo3D/Layers/points.xml";
